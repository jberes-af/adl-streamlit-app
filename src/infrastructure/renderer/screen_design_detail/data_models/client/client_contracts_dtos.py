# /src/infrastructure/screen_design_detail/data_models/client/client_contract_dtos.py
...
from src.infrastructure.renderer.screen_design_detail.data_models.client.request_dto_definitions import (
    ADL_HOME_QUERY_DTO,
...
from src.infrastructure.renderer.screen_design_detail.data_models.client.response_dto_definitions import (
...
from src.infrastructure.renderer.screen_design_detail.data_models.json_contract_definitions import (
...
CLIENT CONTRACTS
"""
ADL_HOME_CLIENT_CONTRACTS = _build_contract(
    ADL_HOME_REQUESTS,
    ADL_HOME_RESPONSES,
)

ADL_ENTRY_CLIENT_CONTRACTS = _build_contract(
    ADL_ENTRY_REQUESTS,
    ADL_ENTRY_RESPONSES,
)

ESCALATION_CLIENT_CONTRACTS = _build_contract(
    ESCALATION_REQUESTS,
    ESCALATION_RESPONSES,
)

OBSERVATION_ENTRY_CLIENT_CONTRACTS = _build_contract(
    OBSERVATION_ENTRY_REQUESTS,
    OBSERVATION_ENTRY_RESPONSES,
)

PATIENT_HISTORY_CLIENT_CONTRACTS = _build_contract(
    PATIENT_HISTORY_REQUESTS,
    PATIENT_HISTORY_RESPONSES,
)

PATIENT_SUMMARY_CLIENT_CONTRACTS = _build_contract(
    PATIENT_SUMMARY_REQUESTS,
    PATIENT_SUMMARY_RESPONSES,
)

REVIEW_QUEUE_CLIENT_CONTRACTS = _build_contract(
    QUEUE_REVIEW_REQUESTS,
    QUEUE_REVIEW_RESPONSES,
)

REVIEW_QUEUE_DETAIL_CLIENT_CONTRACTS = _build_contract(
    REVIEW_QUEUE_DETAIL_REQUESTS,
    REVIEW_QUEUE_DETAIL_RESPONSES,
)
